                      ...
                      <ScrollView>
                        ...
                        >
                          ...
                          {selectedTopTopping.some(
                            (item) =>
                              item.ToppingId == singleTopTopping.ToppingId
                          ) ? (
                              <TouchableOpacity
...
export default connect(mapStateToProps, mapDispatchToProps)(BackHoc(TopToppings));
