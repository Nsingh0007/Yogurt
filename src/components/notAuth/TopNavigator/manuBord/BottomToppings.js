    ...
    return (
      <View style={styles.continer}>
        ...
        <ScrollView>
          ...
          {toppingsData.map((singleBottomTopping, singleBottomToppingIndex) => {
            return (
              <Fragment key={singleBottomToppingIndex}>
                <ScrollView>
                  <View>
                    {singleBottomTopping.ToppingTypeName ===
                    "Popular Toppings" ? (
                      <ScrollView>
                        <View
                          style={{
                        ...
                        >
                          ...
                          {selectBottomToppings.some(
                            (item) =>
                              item.ToppingId == singleBottomTopping.ToppingId
                          ) ? (
                            <TouchableOpacity 
                              onPress={() => {
                                if (isSixPackLogic) {
                                  return this.removeSixPackFlavor(
                                    singleBottomTopping.ToppingId
                                  );
                                }
                                this.props.mutateProductsDispatch(
                                  selectedCategory,
          ...
          {toppingsData.map((singleBottomTopping, singleBottomToppingIndex) => {
            return (
              <Fragment key={singleBottomToppingIndex}>
                <ScrollView>
                  <View>
                    {singleBottomTopping.ToppingTypeName === "Candies" ? (
                      <ScrollView>
                        <View
                          style={{
                            flexDirection: "row",
          ...
          {toppingsData.map((singleBottomTopping, singleBottomToppingIndex) => {
            return (
              <Fragment key={singleBottomToppingIndex}>
                <ScrollView>
                  <View>
                    {singleBottomTopping.ToppingTypeName === "Sauces" ? (
                      <ScrollView>
                        <View
                          style={{
                            flexDirection: "row",
          ...
          {toppingsData.map((singleBottomTopping, singleBottomToppingIndex) => {
            return (
              <Fragment key={singleBottomToppingIndex}>
                <ScrollView>
                  <View>
                    {singleBottomTopping.ToppingTypeName === "Fruits" ? (
                      <ScrollView>
                        <View
                          style={{
                            flexDirection: "row",
...
export default connect(mapStateToProps, mapDispatchToProps)(BackHoc(BottomToppings));
