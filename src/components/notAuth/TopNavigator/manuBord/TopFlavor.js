...
class TopFlavors extends Component {
  constructor(props) {
    super(props);
    this.state = {};
  }
  ...
  handleMutate = (subCategoryData, currentTopTopingArray) => {
    if (subCategoryData.TopFlavorCount > currentTopTopingArray.length) {
      return true;
    } else {
      Alert.alert(
        "Message",
        `Oops! Please select only ${subCategoryData.TopFlavorCount} Flavors`,
        [
          {
            text: "Okay",
          },
  ...
  render() {
    ...
    if (!isSixPackLogic) {
      if (!selectedCategory.isSubCategory) {
        ...
        selectTopFlavorsForSpecificCategory = updatedDemo.topflavours;
        //selectTopFlavorsForSpecificCategory = [];
      }
    } else {
      ...
      <View style={styles.continer}>
        <View style={styles.header}>
          ...
          <View style={{ justifyContent: "center" }}>
            <Text style={styles.headerText}>TOP FLAVORS</Text>
          </View>
                    ...
                    {singleflavor.FlavorTypeName === "Yogurt" ? (
                      <ScrollView>
                        ...
                        >
                          ...
                          {selectTopFlavorsForSpecificCategory.some(
...
export default connect(mapStateToProps, mapDispatchToProps)(BackHoc(TopFlavors));
